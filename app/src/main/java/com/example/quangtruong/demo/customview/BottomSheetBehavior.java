...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), mMaxOffset)) {
    ...
    @Override
    public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V
    ...
    @Override
    public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V
        ...
        Log.d(TAG, "onNestedPreScroll: " + newTop + ", mMinOffset: " + mMinOffset + ", mMaxOffset: " + mMaxOffset);
        if (dy > 0) { // Upward
    ...
    @Override
    public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V
    ...
    @Override
    public boolean onNestedPreFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V
     ...
     *                   ref android.support.design.R.styleable#BottomSheetBehavior_Params_behavior_peekHeight
     */
     ...
     *                 ref android.support.design.R.styleable#BottomSheetBehavior_Params_behavior_hideable
     */
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        public boolean tryCaptureView(@NonNull View child, int pointerId) {
            ...
            if (mState == STATE_EXPANDED && mActivePointerId == pointerId) {
                View scroll = mNestedScrollingChildRef.get();
                if (scroll != null && canChildScrollUp(scroll)) {
