...
public class BackdropBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
         ...
         * flexibility, in case that dependency's height, child's height or {@link BottomSheetBehavior#getPeekHeight()}'s
         ...
         * {@link BottomSheetBehavior#getPeekHeight()} and collapsedY are the same point on screen.
         */
